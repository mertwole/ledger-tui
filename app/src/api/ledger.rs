    ...
    impl LedgerApiMock {
        pub fn new(device_count: usize, account_count: usize) -> Self {
            ...
            let btc_accounts = vec![
                Account {
                    public_key: "0x0123456789012345678901234567890101234567890123456789012345678901".into(),
                },
                Account {
                    public_key: "0x9876543210987654321098765432109876543210987654321098765432109876".into(),
                },
                Account {
                    public_key: "0x0000001111111112222222223333333333344444444445555555555666666666".into(),
                },
                Account {
                    public_key: "0x1230000000000000000000000000000000000000000000000000000000000321".into(),
                },
                Account {
                    public_key: "0x1111000000000000000000000000000000000000000000000000000000001111".into(),
                },
            ];
            ...
            let eth_accounts = vec![Account {
                public_key: "0x1234567891011121123456789101112112345678".into(),
            }];
